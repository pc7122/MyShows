...
{
    $con=mysqli_connect("localhost","root","","myshows");
    $query = "select * from movies where type = 'Latest' order by rating desc";
    $res=mysqli_query($con,$query);
    $d='';
            ...
            success: function (data) {
                if(data == "CLOSE") {
                        ...
                        message.innerHTML = `<div class="alert alert-danger fade show" role="alert">
                                                <strong  mx-100>Multiplexes are currently closed ...</strong>
                                            </div>`;
