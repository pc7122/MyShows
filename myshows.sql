...
('Gaurav', '111gauravshelke@gmail.com', 'Gaurav@admin');
...
('Mumbai Saga', 'assets/img/ms.jpg', 'Crime | Action', 'https://youtu.be/YTGO38DSIsc', 100, '09:00 AM', '', '', 'assets/img/msbig.jpg', 'Latest', '2021-03-19', '2021-06-15', 60, '2D'),
('The Big Bull', 'assets/img/bigbull3.jpg', 'Drama | Crime', 'https://www.youtube.com/watch?v=Bw6I-KgCSP4', 100, '12:00 PM', '06:00 PM', '', 'assets/img/bigbullbig.jpg', 'Latest', '2021-04-08', '2021-07-08', 65, '2D'),
('Godzilla vs Kong', 'assets/img/gk.jpg', 'Action | Science Fiction | Thriller', 'https://youtu.be/odM92ap8_c0', 120, '06:00 PM', '09:00 AM', '11:00 PM', 'assets/img/gkbig.jpg', 'Latest', '2021-03-24', '2021-07-08', 50, '3D'),
('RRR', 'assets/img/rrr.jpg', 'Drama | Historical', 'https://youtu.be/5-4uOgkn9nk', 120, '08:30 PM', '12:00 PM', '', 'assets/img/rrrbig.jpg', 'Latest', '2021-10-13', '2021-11-13', 50, '2D'),
...
('Roohi', 'assets/img/roohi1.jpg', 'Comedy | Horror | Mystery', 'https://youtu.be/mTT_V0t89MI', 100, '11:00 PM', '', '', 'assets/img/roohibig.jpg', 'Latest', '2021-03-11', '2021-05-15', 67, '2D'),
('Tom and Jerry', 'assets/img/tj1.jpg', 'Family | Comedy', 'https://youtu.be/5XeyGcDUdn0', 150, '', '08:30 PM', '', 'assets/img/tjbig.jpeg', 'Latest', '2021-02-26', '2021-07-30', 60, '3D'),
...
('Andaz Apna Apna', 'assets/img/aaa.jpg', 'Comedy | Romance', 'https://youtu.be/fd_w7Qw8biU', 100, '03:00 PM', '', '', 'assets/img/ANDAZ_APNA_APNA_big.jpg', 'Old', '1994-04-11', '2021-07-11', 80, '2D'),
...
('Dilwale Dulhania Le Jayenge', 'assets/img/ddlj.jpg', 'Comedy | Romance | Drama', 'https://youtu.be/cmax1C1p660', 100, '', '', '06:00 PM', 'assets/img/ddljbig.jpg', 'Old', '1995-10-20', '2021-07-30', 71, '2D'),
('Zombivli', 'assets/img/zombivli.jpg', 'Comedy | Horror', 'https://youtu.be/vFTA6ijL2E0', 120, '', '11:00 PM', '', 'assets/img/zombivlibig.jpg', 'Latest', '2021-04-30', '2021-07-30', 50, '2D'),
('Raja Hindustani', 'assets/img/Raja_Hindustani.jpg', 'Comedy | Musical | Drama', 'https://youtu.be/qHhoFdHyJfc', 80, '', '03:00 PM', '', '', 'Old', '2021-04-21', '2021-07-30', 60, '2D');

-- --------------------------------------------------------

--
-- Table structure for table `multiplexstatus`
--

CREATE TABLE IF NOT EXISTS `multiplexstatus` (
  `state` text NOT NULL,
  `date` date NOT NULL,
  `expiry` date NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
-- Dumping data for table `multiplexstatus`
--

INSERT INTO `multiplexstatus` (`state`, `date`, `expiry`) VALUES
('OPEN', '2021-06-28', '2021-07-28');
...
('RRR', 'Screen 1', '2021-06-26', '08:30 PM', 'A7,B7'),
('RRR', 'Screen 1', '2021-07-01', '08:30 PM', ',G7,I6,I7,I8,I9');
...
('prathameshchaudhary7122@gmail.com', 'Roohi', 50),
('chaitanyakolhe4444@gmail.com', 'Roohi', 100),
('111gauravshelke@gmail.com', 'RRR', 10);
...
('Matin', 'shaikhmatin3230@gmail.com', 'matin@user', 'ABCD-10-1,FIRST-20-2,BEST-5-1', 7),
('Prajval', 'prajvalgandhi483@gmail.com', 'paju@user', 'BEST-5-1', 0),
('Prathamesh', 'prathameshchaudhary7122@gmail.com', 'pratham@user', 'BEST-5-1', 39),
('Gaurav', '111gauravshelke@gmail.com', 'Gaurav@user', 'FIRST-10-1,BEST-5-1,RRR-10-1', 0),
('Chaitanya', 'chaitanyakolhe4444@gmail.com', 'chaitu@user', 'FIRST-10-1,BEST-5-1', 0);
